...
| ข้อ | สถานะ | Commit |
|----|-------|--------|
| 1 | [x] ทำแล้ว — หลาย metric ในกราฟเดียว | (commit ล่าสุด) |
| 2 | [x] ทำแล้ว — Host แสดง alert ล่าสุด | (commit ล่าสุด) |
| 3 | [x] ทำแล้ว — Fleet card sparkline | (commit ล่าสุด) |
| 4 | [x] ทำแล้ว — ตาราง Alerts กรอง host | (commit ล่าสุด) |
| 5 | [x] ทำแล้ว — M5.1 ข้อมูล server หน้า ตั้งค่า (M5.2/M5.3 ยังไม่ทำ) | (commit ล่าสุด) |
| 6 | [x] ทำแล้ว — empty/loading สวย + ปุ่มวิธีติดตั้ง | (commit ล่าสุด) |
| 7 | [x] ทำแล้ว — รายละเอียดเล็กๆ 7.1–7.7 | (commit ล่าสุด) |
